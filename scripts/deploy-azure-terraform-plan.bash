...
export TF_VAR_azurerm_client_id="${AZURE_CLIENT_ID}"
export TF_VAR_azurerm_client_secret="${AZURE_CLIENT_SECRET}"
export TF_VAR_azurerm_tenant_id="${AZURE_TENANT_ID}"
export TF_VAR_azurerm_subscription_id="${AZURE_SUBSCRIPTION_ID}"
